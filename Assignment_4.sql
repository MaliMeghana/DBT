...
UPDATE  EMPLOYEE SET SALARY=15000  WHERE DEPT_ID IN (SELECT D.DEPT_ID FROM DEPARTMENT D JOIN EMPLOYEE E ON D.DEPT_ID=E.DEPT_ID WHERE E.EMP_NAME='Max') AND EMP_NAME NOT LIKE 'Max';
